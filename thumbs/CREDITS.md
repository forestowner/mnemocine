...
One image per category, cropped to 300x170 by `scripts/build-thumbs.mjs`. All are from Wikimedia
Commons; follow a link for that file's own licence and author.

| Category | File | Source |
|---|---|---|
| `abstract` | Abstract view from Børsen | [source](https://commons.wikimedia.org/wiki/File:Abstract_view_from_B%C3%B8rsen.jpg) |
| `anatomy` | Photo of Peter M. Lawrence, MS, medical illustrator and researcher at Barrow Neurological Institute, 2019 | [source](https://commons.wikimedia.org/wiki/File:Photo_of_Peter_M._Lawrence,_MS,_medical_illustrator_and_researcher_at_Barrow_Neurological_Institute,_2019.jpg) |
| `architecture` | Architectural drawing 001 | [source](https://commons.wikimedia.org/wiki/File:Architectural_drawing_001.png) |
| `atmosphere` | Cloud cumulonimbus at baltic sea(1) | [source](https://commons.wikimedia.org/wiki/File:Cloud_cumulonimbus_at_baltic_sea(1).jpg) |
| `biome` | Rub' al Khali (Arabian Empty Quarter) sand dunes imaged by Terra (EOS AM-1) | [source](https://commons.wikimedia.org/wiki/File:Rub%27_al_Khali_(Arabian_Empty_Quarter)_sand_dunes_imaged_by_Terra_(EOS_AM-1).jpg) |
| `birds` | Great Blue Heron 0887 | [source](https://commons.wikimedia.org/wiki/File:Great_Blue_Heron_0887.jpg) |
...
| `editorial` | State Arms of the Union (title page, illustrated, 1876) | [source](https://commons.wikimedia.org/wiki/File:State_Arms_of_the_Union_(title_page,_illustrated,_1876).jpg) |
| `electronics` | Sony video Hi8 tape recorder (6498606047) | [source](https://commons.wikimedia.org/wiki/File:Sony_video_Hi8_tape_recorder_(6498606047).jpg) |
| `environments` | Cityscape and skyline by the Copenhagen Lakes, Denmark - (36018109956) | [source](https://commons.wikimedia.org/wiki/File:Cityscape_and_skyline_by_the_Copenhagen_Lakes,_Denmark_-_(36018109956).jpg) |
| `flowers` | LantanaFlowerLeaves | [source](https://commons.wikimedia.org/wiki/File:LantanaFlowerLeaves.jpg) |
| `hardsurface` | US Patent 1583479 | [source](https://commons.wikimedia.org/wiki/File:US_Patent_1583479.jpg) |
| `insects` | Butterfly Luc Viatour | [source](https://commons.wikimedia.org/wiki/File:Butterfly_Luc_Viatour.JPG) |
| `interiors` | Mushara Lodge (3687268891) | [source](https://commons.wikimedia.org/wiki/File:Mushara_Lodge_(3687268891).jpg) |
| `landscape` | Salomon van Ruysdael - View of Egmond aan Zee - WGA20562 | [source](https://commons.wikimedia.org/wiki/File:Salomon_van_Ruysdael_-_View_of_Egmond_aan_Zee_-_WGA20562.jpg) |
| `lighting` | Chiaroscuro 1 | [source](https://commons.wikimedia.org/wiki/File:Chiaroscuro_1.jpg) |
| `mammals` | Kazakh shepard with dogs and horse | [source](https://commons.wikimedia.org/wiki/File:Kazakh_shepard_with_dogs_and_horse.jpg) |
...
| `photoportraits` | Revd William Cadman, preacher and rector of Holy Trinity Church, Marylebone, carte de visite | [source](https://commons.wikimedia.org/wiki/File:Revd_William_Cadman,_preacher_and_rector_of_Holy_Trinity_Church,_Marylebone,_carte_de_visite.jpg) |
